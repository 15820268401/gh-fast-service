...
public class Customer4ParentSysEntity implements Serializable {
    ...
    private Long childSysCustomerId;
    ...
    public Long getChildSysCustomerId() {
        return childSysCustomerId;
    }

    public void setChildSysCustomerId(Long childSysCustomerId) {
        this.childSysCustomerId = childSysCustomerId;
    }
}